...
//   useEffect(() => {
//     // 백엔드에서 데이터 가져오기
//     axios.get('http://192.168.0.82:3000/viewlost/viewlost')
//       .then(response => {
...
//               {item.lost_image_url ? (
//                 <Image source={{ uri: `http://192.168.0.82:3000/viewlost/viewlost${item.lost_image_url}` }} style={styles.itemImage} />
//               ) : (
